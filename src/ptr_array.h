#ifndef SHELL_PTR_ARRAY_H_INCLUDED
#define SHELL_PTR_ARRAY_H_INCLUDED
...
// Destroys the array container without freeing the individual pointers.
// Use when ownership of the elements has been transferred elsewhere.
void ptr_array_destroy_shallow(PtrArray *array);
